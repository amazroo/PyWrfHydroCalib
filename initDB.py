...
def main(argv):
    ...
    try:
        dbConn.execute('''CREATE TABLE Calib_Stats
                       ...
                       nse real, nselog real, kge real, kge_lf real, fdcerr real,
    ...
    try:
        dbConn.execute('''CREATE TABLE Job_Meta 
                       ...
                       slack_user text, mpi_cmd text, cpu_pin_cmd text)''')
    except:
    ...
    try:
        dbConn.execute('''CREATE TABLE Valid_Stats
                        ...
                        cor real, nse real, nselog real, nseWt real, kge real, kge_lf real,
                        msof real, hyperResMultiObj real,
                        nnsesq real, eventmultiobj real, lbem real, lbemprime real, 
                        corr1 real, pod real, far real, csi real,
                        nnse real, peak_bias real, peak_tm_err_hr real, event_volume_bias real,
